...
export default function EditMusic({ params }: { params: { id: string } }) {
  ...
  const handleComposerChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    setSong((prevSong) => ({
      ...prevSong,
      composer: composers.filter(
        (composer) => composer.id_composer === selectedComposerId
      ),
    }));
  };
    ...
    <div className={styles.container}>
      ...
      <div className={styles.formGroup}>
        ...
        <input
          ...
          value={song?.producer || ""}
          onChange={(e) =>
            setSong({ ...song, producer: e.target.value } as Song)
          }
        />
        ...
        >
          ...
          {artists.map((artist) => (
            <option
              ...
              style={{
                backgroundColor: song?.artists.some(
                  (a) => a.id_artist === artist.id_artist
                )
                  ? "lightgreen"
                  : "",
              }}
        ...
        >
          ...
          {types.map((type) => (
            <option
              ...
              value={type.id_type}
              style={{
                backgroundColor: song?.types.some(
                  (t) => t.id_type === type.id_type
                )
                  ? "lightgreen"
                  : "",
              }}
