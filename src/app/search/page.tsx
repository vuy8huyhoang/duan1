...
const SearchResultsPage: React.FC = () => {
    ...
    const paginatedArtists = artistList.slice(
        (currentArtistPage - 1) * itemsPerPage,
        currentArtistPage * itemsPerPage
    );
            ...
            <section>
                ...
                <div className={styles.musicList}>
                    {paginatedMusic.map((music) => (
                        <Link key={music.id_music} href={`/musicdetail/${music.id_music}`} className={styles.musicItem}>
                            <img src={music.url_cover} alt={music.name} className={styles.musicImage} />
                ...
                <div className={styles.pagination}>
                    ...
                    <span>Trang {currentMusicPage} / {totalMusicPages}</span>
                    <button
            ...
            <section>
                ...
                <div className={styles.albumGrid}>
                    {paginatedAlbums.map((album) => (
                        <Link key={album.id_album} href={`/albumdetail/${album.id_album}`} className={styles.albumCard}>
                ...
                <div className={styles.pagination}>
                    ...
                    <span>Trang {currentAlbumPage} / {totalAlbumPages}</span>
                    <button
            ...
            <section>
                ...
                <div className={styles.artistList}>
                    {paginatedArtists.map((artist) => (
                        <Link key={artist.id_artist} href={`/artistdetail/${artist.id_artist}`} className={styles.artistItem}>
                            <img src={artist.url_cover} alt={artist.name} className={styles.artistImage} />
                ...
                <div className={styles.pagination}>
                    ...
                    <span>Trang {currentArtistPage} / {totalArtistPages}</span>
                    <button
