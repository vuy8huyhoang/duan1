...
import styles from "./AdminType.module.scss"; // Assuming you have a category.module.scss for styling
...
const TypeManagement = () => {
  ...
  const fetchType = async () => {
    try {
      const response:any = await axios.get("/type"); // Adjust API endpoint as needed
